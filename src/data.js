...
export const CONTACT = {
  ...
  hours: '9 am - 8 pm',
  details: [
    { icon: 'phone', label: '+91 8595968122', link: 'tel:+918595968122' },
    { icon: 'mail', label: 'consult@dreamcountryvisas.com', link: 'mailto:consult@dreamcountryvisas.com' },
    { icon: 'whatsapp', label: '+91 8595968122 (WhatsApp)', link: 'https://wa.me/918595968122' },
    { icon: 'clock', label: 'Mon - Sat: 9:00 AM - 8:00 PM', link: '#' },
  ],
  offices: [
    {
      label: 'Head Office',
...
export const COUNTRY_DIAL_CODES = [
  ...
  { country: 'Saint Kitts and Nevis', code: '+1-869', flag: '🇰🇳' },
  { country: 'Saint Lucia', code: '+1-758', flag: '🇱🇨' },
  { country: 'Saint Vincent and Grenadines', code: '+1-784', flag: '🇻🇨' },
  ...
  { country: 'Trinidad and Tobago', code: '+1-868', flag: '🇹🇹' },
...
export const ALL_COUNTRIES_LIST = COUNTRY_DIAL_CODES.map((c) => ({
  value: c.country,
...
export const TEAM = [
  {
    ...
    linkedin: 'https://www.linkedin.com/in/ushasharmauniglobe/',
  ...
  },
  {
    ...
    linkedin: 'https://www.linkedin.com/in/mohhit-s-11ab34115/',
  ...
  latvia: [
    {
      ...
      a: "Yes, starting from €50,000 through the business investment route, Latvia remains one of the most affordable EU residency programs, well below Portugal or Malta's thresholds.",
    },
    {
      q: 'Is the Latvia real estate route still available?',
      a: 'No, the real estate and bank deposit routes officially closed on 14 September 2026 under the new Immigration Law. Applications filed on or before that date are still processed under the previous rules; new applicants can no longer use these two routes.',
    },
    {
      q: 'What are the current routes to Latvia residency after September 2026?',
      a: 'Yes, the surviving routes are a business investment (from €50,000 for a small business, or €100,000 for larger companies, each plus a €10,000 state fee) and a new fund investment route of €150,000 held for 5 years plus a €10,000 state fee.',
    },
    {
    ...
    },
    {
      ...
      a: 'Yes, the program allows you to include your spouse and dependent children under the same application, with separate minimum financial proof required per dependent.',
    },
  ],
